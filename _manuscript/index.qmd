...
**Definitions:** When a patient is admitted to acute care with a mental crisis it might be their first visit or the most recent in a long history of crisis events. At each event, a mix of information is collected including structured data comprised of discrete variables (i.e., gender, diagnoses, and school district), continuous variables (i.e., standardized assessment scores) and administrative data (i.e., number of visits, hours of service) as well as time based data like intake, discharge and assessment dates. Unstructured data is usually composed of clinical notes....

## Problem Statement

The primary objective of the study was to improve the accuracy of @garriga2023 's earlier models where they leveraged structured EHRs to predict mental health crises, this time by including unstructured mental health data. The main challenge posed by clinical note data is the reality that the information contained in any one EHR varies significantly from patient to patient. Moreover, clincian-level idosyncricies like personal style, work habits and clinical modality mean that the quality, availability and volume of clinical notes in EHRs is highly inconsistent. Moreover, they found that the severity and frequency of a patients mental health crises was positively correlated with the volume of notes within the EHR, meaning that those with more severe or recurrent episodes typically had a greater volume of clinical notes. As such, it was important to establish the minimum quantity of unstructured data that would contribute to the accurate prediction of mental health crises and still remain effective across a spectrum of patient complexity, regardless of the volume of clinical notes.
